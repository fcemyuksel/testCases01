...
public class WindowHandling04 {
    ...
    public void test04() throws InterruptedException {
        ...
        driver.get("https://www.trendyol.com/");
        driver.findElement(By.xpath("//input[@placeholder='Aradığınız ürün, kategori veya markayı yazınız']")).sendKeys("kedi maması"+Keys.ENTER);
